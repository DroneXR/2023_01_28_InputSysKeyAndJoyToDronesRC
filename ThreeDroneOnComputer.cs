...
namespace LocalDroneInputSpace
{
    ...
    ""controlSchemes"": []
        ...
        private IDroneAzertyActions m_DroneAzertyActionsCallbackInterface;
        ...
        public struct DroneAzertyActions
        {
            ...
            {
                if (m_Wrapper.m_DroneAzertyActionsCallbackInterface != null)
                {
                    @LeftRight.started -= m_Wrapper.m_DroneAzertyActionsCallbackInterface.OnLeftRight;
                    @LeftRight.performed -= m_Wrapper.m_DroneAzertyActionsCallbackInterface.OnLeftRight;
                    @LeftRight.canceled -= m_Wrapper.m_DroneAzertyActionsCallbackInterface.OnLeftRight;
                    @BackForward.started -= m_Wrapper.m_DroneAzertyActionsCallbackInterface.OnBackForward;
                    @BackForward.performed -= m_Wrapper.m_DroneAzertyActionsCallbackInterface.OnBackForward;
                    @BackForward.canceled -= m_Wrapper.m_DroneAzertyActionsCallbackInterface.OnBackForward;
                    @DownUp.started -= m_Wrapper.m_DroneAzertyActionsCallbackInterface.OnDownUp;
                    @DownUp.performed -= m_Wrapper.m_DroneAzertyActionsCallbackInterface.OnDownUp;
                    @DownUp.canceled -= m_Wrapper.m_DroneAzertyActionsCallbackInterface.OnDownUp;
                    @RotateLeftRight.started -= m_Wrapper.m_DroneAzertyActionsCallbackInterface.OnRotateLeftRight;
                    @RotateLeftRight.performed -= m_Wrapper.m_DroneAzertyActionsCallbackInterface.OnRotateLeftRight;
                    @RotateLeftRight.canceled -= m_Wrapper.m_DroneAzertyActionsCallbackInterface.OnRotateLeftRight;
                }
                m_Wrapper.m_DroneAzertyActionsCallbackInterface = instance;
                if (instance != null)
                {
                    @LeftRight.started += instance.OnLeftRight;
                    @LeftRight.performed += instance.OnLeftRight;
